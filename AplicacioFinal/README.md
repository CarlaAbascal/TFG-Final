...
2\. Entrar a la carpeta de l'aplicació:
...
Si no es restauren automàticament, cal fer clic dret sobre la solució `WindowsFormsApp1` dins del **Solution Explorer** i seleccionar:
